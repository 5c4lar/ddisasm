...
OpToken PrintLLVM::pointer_member = {"->", 2, 66, true, OpToken::binary, 0, 0, (OpToken *)0};
OpToken PrintLLVM::subscript = {"[]", 2, 66, false, OpToken::postsurround, 0, 0, (OpToken *)0};
OpToken PrintLLVM::function_call = {"()", 2, 66, false, OpToken::postsurround, 0, 10, (OpToken *)0};
OpToken PrintLLVM::bitwise_not = {"~", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::boolean_not = {"!", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::unary_minus = {"-", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::unary_plus = {"+", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::addressof = {"&", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::dereference = {"*", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::typecast = {"()", 2, 62, false, OpToken::presurround, 0, 0, (OpToken *)0};
OpToken PrintLLVM::multiply = {"*", 2, 54, true, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::divide = {"/", 2, 54, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::modulo = {"%", 2, 54, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::binary_plus = {"+", 2, 50, true, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::binary_minus = {"-", 2, 50, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::shift_left = {"<<", 2, 46, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::shift_right = {">>", 2, 46, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::shift_sright = {">>", 2, 46, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::less_than = {"<", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::less_equal = {"<=", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::greater_than = {">", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::greater_equal = {">=", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::equal = {"==", 2, 38, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::not_equal = {"!=", 2, 38, false, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::bitwise_and = {"&", 2, 34, true, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::bitwise_xor = {"^", 2, 30, true, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::bitwise_or = {"|", 2, 26, true, OpToken::binary, 1, 0, (OpToken *)0};
OpToken PrintLLVM::boolean_and = {"&&", 2, 22, false, OpToken::binary, 1, 0, (OpToken *)0};
...
OpToken PrintLLVM::multequal = {"*=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::divequal = {"/=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::remequal = {"%=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::plusequal = {"+=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::minusequal = {"-=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::leftequal = {"<<=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::rightequal = {">>=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::andequal = {"&=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::orequal = {"|=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};
OpToken PrintLLVM::xorequal = {"^=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0};

// Operator tokens for type expressions
OpToken PrintLLVM::type_expr_space = {"", 2, 10, false, OpToken::space, 1, 0, (OpToken *)0};
OpToken PrintLLVM::type_expr_nospace = {"", 2, 10, false, OpToken::space, 0, 0, (OpToken *)0};
OpToken PrintLLVM::ptr_expr = {"*", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0};
OpToken PrintLLVM::array_expr = {"[]", 2, 66, false, OpToken::postsurround, 1, 0, (OpToken *)0};
OpToken PrintLLVM::enum_cat = {"|", 2, 26, true, OpToken::binary, 0, 0, (OpToken *)0};

const string PrintLLVM::typePointerRelToken = "ADJ";

// Constructing this registers the capability
PrintLLVMCapability PrintLLVMCapability::printLLVMCapability;

PrintLLVMCapability::PrintLLVMCapability(void)
...
PrintLanguage *PrintLLVMCapability::buildLanguage(Architecture *glb)

{
    return new PrintLLVM(glb, name);
}

/// \param g is the Architecture owning this llvm-language emitter
/// \param nm is the name assigned to this emitter
PrintLLVM::PrintLLVM(Architecture *g, const string &nm) : PrintLanguage(g, nm)
...
void PrintLLVM::buildTypeStack(const Datatype *ct, vector<const Datatype *> &typestack)
...
void PrintLLVM::pushPrototypeInputs(const FuncProto *proto)

{
    ...
    else
    {
        ...
        if(proto->isDotdotdot())
        {
            ...
            {
                // In ANSI C, a prototype with empty parens means the parameters are unspecified
                // (not void) In C++, empty parens mean void, we use the ANSI C convention
...
void PrintLLVM::pushSymbolScope(const Symbol *symbol)

{
    ...
    if(scopedepth != 0)
    {
        ...
        {
            pushAtom(Atom(scopeList[i]->getName(), syntax, EmitXml::global_color, (PcodeOp *)0,
                          (Varnode *)0));
        }
    }
}
...
/// the current scope.
/// \param symbol is the given Symbol
void PrintLLVM::emitSymbolScope(const Symbol *symbol)
...
void PrintLLVM::pushTypeStart(const Datatype *ct, bool noident)
...
void PrintLLVM::pushTypeEnd(const Datatype *ct)

{
    ...
    for(;;)
    {
        ...
        else if(ct->getMetatype() == TYPE_ARRAY)
        {
            ...
            ct = ctarray->getBase();
            push_integer(ctarray->numElements(), 4, false, (const Varnode *)0, (const PcodeOp *)0);
        }
        else if(ct->getMetatype() == TYPE_CODE)
        {
...
bool PrintLLVM::checkArrayDeref(const Varnode *vn) const
...
void PrintLLVM::opFunc(const PcodeOp *op)
...
/// The syntax represents the given op using a standard llvm-language cast.  The data-type
/// being cast to is obtained from the output variable of the op. The input expression is
/// also recursively pushed.
/// \param op is the given PcodeOp
void PrintLLVM::opTypeCast(const PcodeOp *op)
...
/// \param op is the given PcodeOp
void PrintLLVM::opHiddenFunc(const PcodeOp *op)
...
void PrintLLVM::opCopy(const PcodeOp *op)

{
    pushVnImplied(op->getIn(0), op, mods);
}

void PrintLLVM::opLoad(const PcodeOp *op)
...
void PrintLLVM::opStore(const PcodeOp *op)
...
void PrintLLVM::opBranch(const PcodeOp *op)
...
void PrintLLVM::opCbranch(const PcodeOp *op)
...
void PrintLLVM::opBranchind(const PcodeOp *op)
...
void PrintLLVM::opCall(const PcodeOp *op)

{
    ...
    if(callpoint->getSpace()->getType() == IPTR_FSPEC)
    {
        ...
        else
        {
            ...
            pushAtom(
                Atom(fc->getName(), functoken, EmitXml::funcname_color, op, (const Funcdata *)0));
        }
    }
    else
    {
...
void PrintLLVM::opCallind(const PcodeOp *op)
...
void PrintLLVM::opCallother(const PcodeOp *op)
...
void PrintLLVM::opConstructor(const PcodeOp *op, bool withNew)
...
void PrintLLVM::opReturn(const PcodeOp *op)
...
void PrintLLVM::opIntZext(const PcodeOp *op, const PcodeOp *readOp)

{
    if(castStrategy->isZextCast(op->getOut()->getHigh()->getType(),
...
void PrintLLVM::opIntSext(const PcodeOp *op, const PcodeOp *readOp)

{
    if(castStrategy->isSextCast(op->getOut()->getHigh()->getType(),
                                op->getIn(0)->getHigh()->getType()))
    {
        if(option_hide_exts && castStrategy->isExtensionCastImplied(op, readOp))
            opHiddenFunc(op);
...
void PrintLLVM::opBoolNegate(const PcodeOp *op)

{
    ...
    {                          // Check if we are negated by a previous BOOL_NEGATE
        ...
        pushVnImplied(op->getIn(0), op,
                      mods); // Don't print ourselves, but print our input unmodified
    }
    else if(checkPrintNegation(op->getIn(0)))
    { // If the next operator can be flipped
        pushVnImplied(op->getIn(0), op,
                      mods | negatetoken); // Don't print ourselves, but print a modified input
    }
    else
    {
...
void PrintLLVM::opSubpiece(const PcodeOp *op)
...
void PrintLLVM::opPtradd(const PcodeOp *op)
...
void PrintLLVM::opPtrsub(const PcodeOp *op)

{
    ...
    if(ct->getMetatype() == TYPE_STRUCT)
    {
        ...
        {
            if(ct->getSize() <= static_cast<int4>(suboff))
            {
                clear();
                throw LowlevelError("PTRSUB out of bounds into struct");
            }
            // Try to match the Ghidra's default field name from
...
void PrintLLVM::opSegmentOp(const PcodeOp *op)

{
    pushVnImplied(op->getIn(2), op, mods);
}

void PrintLLVM::opCpoolRefOp(const PcodeOp *op)
...
void PrintLLVM::opNewOp(const PcodeOp *op)
...
void PrintLLVM::opInsertOp(const PcodeOp *op)

{
    opFunc(op); // If no other way to print it, print as functional operator
}

void PrintLLVM::opExtractOp(const PcodeOp *op)
...
void PrintLLVM::push_integer(uintb val, int4 sz, bool sign, const Varnode *vn, const PcodeOp *op)
{
    bool print_negsign;
    ...
    { // Otherwise decide if dec or hex is more natural
        displayFormat =
            (PrintLanguage::mostNaturalBase(val) == 16) ? Symbol::force_hex : Symbol::force_dec;
    }
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintLLVM::push_float(uintb val, int4 sz, const Varnode *vn, const PcodeOp *op)
{
    string token;
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                for(int4 i = 0; i < static_cast<int4>(token.size()); ++i)
                {
                    char c = token[i];
                    if(c == '.' || c == 'e')
                    {
...
void PrintLLVM::printUnicode(ostream &s, int4 onechar) const
...
void PrintLLVM::pushType(const Datatype *ct)
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintLLVM::pushBoolConstant(uintb val, const TypeBase *ct, const Varnode *vn,
                                 const PcodeOp *op)
{
    if(val != 0)
...
///
/// The llvm-language standard requires that strings (and character constants) made up of \e wide
/// character elements have an 'L' prefix added before the quote characters.  Other related
/// languages may not do this.  Having this as a virtual method lets derived languages to tailor
/// their strings while still using the basic PrintLLVM functionality \return \b true if a prefix
/// should be printed
bool PrintLLVM::doEmitWideCharPrefix(void) const
{
    return true;
}
...
void PrintLLVM::printCharHexEscape(ostream &s, int4 val)
...
bool PrintLLVM::printCharacterConstant(ostream &s, const Address &addr, Datatype *charType) const
...
int4 PrintLLVM::getHiddenThisSlot(const PcodeOp *op, FuncProto *fc)
...
void PrintLLVM::resetDefaultsPrintC(void)
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintLLVM::pushCharConstant(uintb val, const Datatype *ct, const Varnode *vn,
                                 const PcodeOp *op)

{
    ...
    if((vn != (const Varnode *)0) && (!vn->isAnnotation()))
    {
        ...
        if(sym != (Symbol *)0)
        {
            ...
            displayFormat = sym->getDisplayFormat();
            if(displayFormat == Symbol::force_bin || displayFormat == Symbol::force_dec
               || displayFormat == Symbol::force_oct)
            {
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintLLVM::pushEnumConstant(uintb val, const TypeEnum *ct, const Varnode *vn,
                                 const PcodeOp *op)
{
    ...
    if(valnames.size() > 0)
    {
        ...
        for(int4 i = valnames.size() - 1; i > 0; --i)
            pushOp(&enum_cat, op);
        for(int4 i = 0; i < static_cast<int4>(valnames.size()); ++i)
...
bool PrintLLVM::pushPtrCharConstant(uintb val, const TypePointer *ct, const Varnode *vn,
                                    const PcodeOp *op)
...
bool PrintLLVM::pushPtrCodeConstant(uintb val, const TypePointer *ct, const Varnode *vn,
                                    const PcodeOp *op)
{
...
void PrintLLVM::pushConstant(uintb val, const Datatype *ct, const Varnode *vn, const PcodeOp *op)
{
    Datatype *subtype;
...
bool PrintLLVM::pushEquate(uintb val, int4 sz, const EquateSymbol *sym, const Varnode *vn,
                           const PcodeOp *op)

{
    ...
    { // If 1-bits are getting masked
        if(sign_extend(modval, sz, sizeof(uintb))
           != baseval) // make sure we only mask sign extension bits
            return false;
    }
    if(modval == val)
    {
...
void PrintLLVM::pushAnnotation(const Varnode *vn, const PcodeOp *op)

{
    ...
    {
        // This construction is for volatile CALLOTHERs where the input annotation is the original
        // address of the volatile access
        ...
        if(userind == vw_op->getIndex())
        {                                   // Annotation from a volatile write
    ...
    else
    {
        ...
        if(regname.empty())
        {
            ...
            pushConstant(AddrSpace::byteToAddress(vn->getOffset(), vn->getSpace()->getWordSize()),
                         ct, vn, op);
        }
        else
...
void PrintLLVM::pushUnnamedLocation(const Address &addr, const Varnode *vn, const PcodeOp *op)
{
    ostringstream s;
...
void PrintLLVM::pushPartialSymbol(const Symbol *sym, int4 off, int4 sz, const Varnode *vn,
                                  const PcodeOp *op, Datatype *outtype)
{
        ...
        else if(ct->getMetatype() == TYPE_ARRAY)
        {
            ...
            if(arrayof != (Datatype *)0)
            {
                ...
                && castStrategy->isSubpieceCastEndian(
                    outtype, ct, off, sym->getFirstWholeMap()->getAddr().getSpace()->isBigEndian()))
        {
    ...
    for(int4 i = 0; i < static_cast<int4>(stack.size()); ++i)
    {
        const TypeField *field = stack[i].field;
        if(field == (const TypeField *)0)
            pushAtom(Atom(stack[i].fieldname, syntax, stack[i].hilite, op));
        else
            pushAtom(Atom(stack[i].fieldname, fieldtoken, stack[i].hilite, stack[i].parent,
                          field->offset));
    }
}

void PrintLLVM::pushMismatchSymbol(const Symbol *sym, int4 off, int4 sz, const Varnode *vn,
                                   const PcodeOp *op)
{
    if(off == 0)
    {
...
void PrintLLVM::emitStructDefinition(const TypeStruct *ct)
...
void PrintLLVM::emitEnumDefinition(const TypeEnum *ct)

{
    ...
    while(iter != ct->endEnum())
    {
        ...
        emit->spaces(1);
        push_integer((*iter).first, ct->getSize(), sign, (Varnode *)0, (PcodeOp *)0);
        recurse();
        emit->print(";");
        ++iter;
        if(iter != ct->endEnum())
    ...
    {
        {
            ...
            case type_metatype::TYPE_ARRAY:
                if(dynamic_cast<const TypeArray *>(dtype)->getSize() == 0)
                    return llvm::Type::getVoidTy(*LLVM_Context);
                else
...
void PrintLLVM::emitPrototypeOutput(const FuncProto *proto, const Funcdata *fd)
{
    PcodeOp *op;
    Varnode *vn;
...
std::vector<llvm::Type *> PrintLLVM::buildPrototypeInputs(const FuncProto *proto)
{
    std::vector<llvm::Type *> args;
    for(int4 i = 0; i < proto->numParams(); ++i)
    {
        ProtoParameter *param = proto->getParam(i);
        auto itype = translateType(param->getType());
        if(param->getType()->getMetatype() != type_metatype::TYPE_VOID && itype)
        {
...
void PrintLLVM::emitPrototypeInputs(const FuncProto *proto)
...
PrintLLVM::GlobalSym *PrintLLVM::getGlobalSym(const Varnode *vn)

{
    AddrSpace *spc = glb->getDefaultDataSpace();
    auto val = vn->getOffset();
    std::cout << "Looking up at " << val << std::endl;
    auto iter = SymMap.find(val);
    if(iter != SymMap.end())
    {
        std::cout << "Found symbol " << iter->second->name << std::endl;
        return iter->second;
    }
    else
    {
...
{
    std::cout << "Processing varnode " << std::endl;
    vn->printRaw(std::cout);
    std::cout << " of type ==> ";
    vn->getType()->printRaw(std::cout);
    std::cout << std::endl;
    AddrSpace *space = vn->getSpace();
    auto space_name = space->getName();
    std::cout << "Space name is " << space_name << std::endl;
    auto ltype = translateType(vn->getType());
    ...
    {
        res = IRBuilder->CreateBitOrPointerCast(res, ltype);
    }
...
llvm::FunctionType *PrintLLVM::getCallType(const PcodeOp *op)
{
    ...
    if(op->getOut())
    {
        // auto out = getVarnodeValue(op->getOut());
    ...
    for(int i = 1; i <= op->numInput() - 1; ++i)
    {
        ...
        auto inval = getVarnodeValue(in);
        InputTypes.push_back(inval->getType());
...
{
    auto in = getVarnodeValue(op->getIn(1));
    auto otype = translateType(op->getOut()->getType());
    auto vn = op->getOut();
...
void PrintLLVM::buildOpCall(const PcodeOp *op)
{
    ...
    if(callpoint->getSpace()->getType() == IPTR_FSPEC)
    {
        fc = FuncCallSpecs::getFspecFromConst(callpoint->getAddr());
        Funcdata *fd = fc->getFuncdata();
        std::cout << "Processing FuncValue call " << std::endl;
        std::cout << fd->getName();
        std::cout << std::endl;
...
void PrintLLVM::buildOpCallind(const PcodeOp *op)
{
    ...
    const Varnode *callpoint = op->getIn(0);
    auto FuncValue = getVarnodeValue(callpoint);
    std::cout << "Processing Indirect Call " << std::endl;
    FuncValue->print(llvm::outs());
    llvm::Type *OutputType;
    std::vector<llvm::Type *> InputTypes;
    std::vector<llvm::Value *> args;
...
void PrintLLVM::buildOpIntEqual(const PcodeOp *op)
{
    ...
    auto out = IRBuilder->CreateICmpEQ(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
void PrintLLVM::buildOpIntZext(const PcodeOp *op)
{
    auto in = getVarnodeValue(op->getIn(0));
    auto otype = translateType(op->getOut()->getType());
    auto out = IRBuilder->CreateZExt(in, otype);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpIntSext(const PcodeOp *op)
{
    auto in = getVarnodeValue(op->getIn(0));
    auto otype = translateType(op->getOut()->getType());
    auto out = IRBuilder->CreateSExt(in, otype);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
void PrintLLVM::buildOpIntMult(const PcodeOp *op)
{
    auto lhs = getVarnodeValue(op->getIn(0));
    auto rhs = getVarnodeValue(op->getIn(1));
    auto out = IRBuilder->CreateMul(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpIntDiv(const PcodeOp *op)
{
    auto lhs = getVarnodeValue(op->getIn(0));
    auto rhs = getVarnodeValue(op->getIn(1));
    auto out = IRBuilder->CreateUDiv(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpIntSdiv(const PcodeOp *op)
{
    auto lhs = getVarnodeValue(op->getIn(0));
    auto rhs = getVarnodeValue(op->getIn(1));
    auto out = IRBuilder->CreateSDiv(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpIntRem(const PcodeOp *op)
{
    auto lhs = getVarnodeValue(op->getIn(0));
    auto rhs = getVarnodeValue(op->getIn(1));
    auto out = IRBuilder->CreateURem(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpIntSrem(const PcodeOp *op)
{
    auto lhs = getVarnodeValue(op->getIn(0));
    auto rhs = getVarnodeValue(op->getIn(1));
    auto out = IRBuilder->CreateSRem(lhs, rhs);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
void PrintLLVM::buildOpFloatAbs(const PcodeOp *op)
{
    auto in = getVarnodeValue(op->getIn(0));
    auto F =
        llvm::Intrinsic::getDeclaration(LLVM_Module.get(), llvm::Intrinsic::fabs, in->getType());
...
void PrintLLVM::buildOpFloatSqrt(const PcodeOp *op)
{
    auto in = getVarnodeValue(op->getIn(0));
    auto F =
        llvm::Intrinsic::getDeclaration(LLVM_Module.get(), llvm::Intrinsic::sqrt, in->getType());
    auto out = IRBuilder->CreateCall(F, in);
    const Varnode *vn = op->getOut();
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
void PrintLLVM::buildOpFloatCeil(const PcodeOp *op)
{
    ...
    const Varnode *vn = op->getOut();
    auto F =
        llvm::Intrinsic::getDeclaration(LLVM_Module.get(), llvm::Intrinsic::ceil, in->getType());
    auto out = IRBuilder->CreateCall(F, in);
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpFloatFloor(const PcodeOp *op)
{
    ...
    const Varnode *vn = op->getOut();
    auto F =
        llvm::Intrinsic::getDeclaration(LLVM_Module.get(), llvm::Intrinsic::floor, in->getType());
    auto out = IRBuilder->CreateCall(F, in);
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
void PrintLLVM::buildOpFloatRound(const PcodeOp *op)
{
    ...
    const Varnode *vn = op->getOut();
    auto F =
        llvm::Intrinsic::getDeclaration(LLVM_Module.get(), llvm::Intrinsic::round, in->getType());
    auto out = IRBuilder->CreateCall(F, in);
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
void PrintLLVM::buildOpPtrsub(const PcodeOp *op)
{
    ...
    auto rhs = getVarnodeValue(op->getIn(1));
    const Varnode *vn = op->getOut();
    std::cout << "Ptrsub Addr ";
    op->getIn(1)->getAddr().printRaw(std::cout);
    std::cout << std::endl;
    auto Offset = op->getIn(1)->getOffset();
    auto AddrLoc = Address(curfunc->getScopeLocal()->getSpaceId(), Offset);
    auto AddrDataGlb = Address(glb->getDefaultDataSpace(), Offset);
    auto AddrCodeGlb = Address(glb->getDefaultCodeSpace(), Offset);
    auto iterLoc = LLVM_LocVarMap.find(AddrLoc);
    auto iterGlb = LLVM_LocVarMap.find(AddrDataGlb);
    auto otype = translateType(dynamic_cast<TypePointer *>(vn->getType())->getPtrTo());
    llvm::Value *out;
    auto fd = glb->symboltab->getGlobalScope()->findFunction(AddrCodeGlb);
    if(iterLoc != LLVM_LocVarMap.end())
    {
        std::cout << "Found local in LocVarMap" << std::endl;
        out = iterLoc->second;
        out->print(llvm::outs());
        std::cout << std::endl;
        std::cout << "Local Var Type ";
        auto loc_type = out->getType();
        loc_type->print(llvm::outs());
        std::cout << std::endl;
        if(loc_type->getPointerElementType()->isArrayTy())
        {
            ...
            std::vector<llvm::Value *> Indices = {
                ...
                llvm::ConstantInt::get(llvm::Type::getInt64Ty(*LLVM_Context), 0)};
            out = IRBuilder->CreateGEP(arrayType, out, Indices);
        }
        LLVM_ValueMap.insert(std::make_pair(vn, out));
        return;
    }
    else if(iterGlb != LLVM_LocVarMap.end())
    {
        std::cout << "Found global in LocVarMap" << std::endl;
        out = iterGlb->second;
        LLVM_ValueMap.insert(std::make_pair(vn, out));
        return;
    }
    ...
    {
        std::cout << "Found function in Symtable" << std::endl;
        auto iterFunc = LLVM_FunctionMap.find(fd);
        if(iterFunc != LLVM_FunctionMap.end())
        {
            std::cout << "Found in FunctionMap" << std::endl;
            out = iterFunc->second;
        }
        else
        {
            std::cout << "Declaring function " << fd->getName() << std::endl;
            out = buildFunctionDeclaration(fd);
        }
        LLVM_ValueMap.insert(std::make_pair(vn, out));
        return;
    }
    ...
    out = IRBuilder->CreateIntToPtr(res, translateType(vn->getType()));
    LLVM_ValueMap.insert(std::make_pair(vn, out));
}
...
{
    std::cout << "Processing " << get_opname(inst->getOpcode()->getOpcode()) << " "
              << inst->getSeqNum() << std::endl;
    inst->printRaw(std::cout);
    std::cout << std::endl;
    curop = inst;
...
void PrintLLVM::emitStatement(const PcodeOp *inst)
...
/// construct a statement with the appropriate llvm-language keyword (\b goto, \b break, \b
/// continue) representing a control-flow branch between the blocks. \param bl is the source block
/// \param exp_bl is the destination block (which may provide a label)
/// \param type is the given type of the branch
void PrintLLVM::emitGotoStatement(const FlowBlock *bl, const FlowBlock *exp_bl, uint4 type)
...
void PrintLLVM::resetDefaults(void)
...
void PrintLLVM::adjustTypeOperators(void)
...
void PrintLLVM::setCommentStyle(const string &nm)

{
    if((nm == "c") || ((nm.size() >= 2) && (nm[0] == '/') && (nm[1] == '*')))
        setCStyleComments();
    else if((nm == "cplusplus") || ((nm.size() >= 2) && (nm[0] == '/') && (nm[1] == '/')))
...
void PrintLLVM::emitTypeDefinition(const Datatype *ct)
...
bool PrintLLVM::checkPrintNegation(const Varnode *vn)

{
    ...
    bool reorder = false;
    OpCode opc = get_booleanflip(op->code(),
                                 reorder); // This is the set of ops that can be negated as a token
    if(opc == CPUI_MAX)
        return false;
    return true;
}

void PrintLLVM::docTypeDefinitions(const TypeFactory *typegrp)
...
/// Check that the given p-code op has an \e in-place token form and if the first input and the
/// output are references to  the same variable. If so, emit the expression using the \e in-place
/// token. \param op is the given PcodeOp \return \b true if the expression was emitted (as
/// in-place), or \b false if not emitted at all
bool PrintLLVM::emitInplaceOp(const PcodeOp *op)

{
    ...
    if(op->getOut()->getHigh() != vn->getHigh())
        return false;
    pushOp(tok, op);
...

{
    ...
    if(outvn != (Varnode *)0)
    {
        if(option_inplace_ops && emitInplaceOp(op))
            return;
...

{
    ...
    if(space && space->getName() == "stack")
    {
        std::cout << "Processing symbol " << sym->getName() << std::endl;
        ...
        std::cout << "Creating Loc Var: " << sym->getName() << " at ";
        Addr.printRaw(std::cout);
        std::cout << std::endl;
    }
}
...
bool PrintLLVM::buildScopeVarDecls(const Scope *symScope, int4 cat)
...
bool PrintLLVM::emitScopeVarDecls(const Scope *symScope, int4 cat)
...
llvm::Function *PrintLLVM::buildFunctionDeclaration(const Funcdata *fd)
{
    ...
    for(auto &Arg : F->args())
    {
        ...
        std::cout << "Creating Arg: " << Arg.getName().str() << " at ";
        ParamAddr.printRaw(std::cout);
        std::cout << std::endl;
    }
...
void PrintLLVM::emitFunctionDeclaration(const Funcdata *fd)
{
    ...
    if(option_convention)
    {
        ...
        {
            if(!fd->getFuncProto().hasMatchingModel(fd->getArch()->defaultfp))
            { // If not the default
    ...
    emit->tagFuncName(fd->getName().c_str(), EmitXml::funcname_color, fd, (PcodeOp *)0);
...
void PrintLLVM::emitGlobalVarDeclsRecursive(Scope *symScope)
...

{
    ...
    {
        auto blk = dynamic_cast<BlockBasic *>(*iter);
        auto bb = LLVM_BlockMap.find(blk)->second;
        IRBuilder->SetInsertPoint(bb);
        buildBlockBasic(blk);
    }
    for(auto &op : PhiOps)
...
void PrintLLVM::emitBlockGoto(const BlockGoto *bl)
...
void PrintLLVM::emitBlockLs(const BlockList *bl)
...
void PrintLLVM::emitBlockCondition(const BlockCondition *bl)
...
void PrintLLVM::emitBlockIf(const BlockIf *bl)
...
void PrintLLVM::emitForLoop(const BlockWhileDo *bl)
...
void PrintLLVM::emitBlockWhileDo(const BlockWhileDo *bl)
...
void PrintLLVM::emitBlockDoWhile(const BlockDoWhile *bl)
...
void PrintLLVM::emitBlockInfLoop(const BlockInfLoop *bl)
...
void PrintLLVM::emitSwitchCase(int4 casenum, const BlockSwitch *switchbl)
...
void PrintLLVM::emitLabel(const FlowBlock *bl)
...
void PrintLLVM::emitLabelStatement(const FlowBlock *bl)
...
/// \param bl is the given control-flow block
void PrintLLVM::emitAnyLabelStatement(const FlowBlock *bl)
...
void PrintLLVM::emitCommentGroup(const PcodeOp *inst)
...
void PrintLLVM::emitCommentBlockTree(const FlowBlock *bl)

{
    if(bl == (const FlowBlock *)0)
        return;
...
void PrintLLVM::emitCommentFuncHeader(const Funcdata *fd)

{
    ...
    while(commsorter.hasNext())
    {
        ...
        if(comm->isEmitted())
            continue;
        if((head_comment_type & comm->getType()) == 0)
            continue;
...
void PrintLLVM::emitBlockSwitch(const BlockSwitch *bl)
    ...
    for(int4 i = 0; i < bl->getNumCaseBlocks(); ++i)
    {
        ...
        else
        {
            ...
            { // Blocks that formally exit the switch
                emit->tagLine();
                emitGotoStatement(bl2, (const FlowBlock *)0,
                                  FlowBlock::f_break_goto); // need an explicit break statement
            }
            emit->endBlock(id2);
        }
        emit->stopIndent(id);
...
string PrintLLVM::genericFunctionName(const Address &addr)
...
/// \param ct is the given data-type
/// \return the generated name
string PrintLLVM::genericTypeName(const Datatype *ct)
